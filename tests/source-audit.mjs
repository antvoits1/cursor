...
check('No Twilio token backend remains', absent('api') && absent('server') && not(JSON.stringify(pkg.scripts),'token-server'));
check('No Twilio dependency exists in package.json', !/twilio/i.test(JSON.stringify({ ...pkg.dependencies, ...pkg.devDependencies })));
