...
- Middle panel: KPI strip (monthly revenue, requested, offer on file, current balance) with accent bars, position pill, JetBrains Mono financial figures, carded sales pitch with blue accent edge, tinted activity icons.
